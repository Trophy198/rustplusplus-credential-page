...
const DiscordBotSetupSection = ({ imageUrls }: { imageUrls: ImageUrl }) => {
  return (
    <section className={styles.container}>
      ...
      <Image src={imageUrls.CopyApplicationIdBotSetup} alt="copy-application-id-bot-setup" placeholder="blur" />
      ...
      <Image src={imageUrls.YesCreateBotBotSetup} alt="yes-create-bot-bot-setup" placeholder="blur" />
      <OrderedList start={7} items={data.getTokenResetStep()} />
      <Image src={imageUrls.ResetTokenBotSetup} alt="reset-token-bot-setup" placeholder="blur" />
      <OrderedList start={8} items={data.getTokenSetupStep()} />
      <Image src={imageUrls.BotTokenBotSetup} alt="bot-token-bot-setup" placeholder="blur" />
      ...
      <Image src={imageUrls.BotPermissionsBotSetup} alt="bot-permissions-bot-setup" placeholder="blur" />
      <OrderedList start={13} items={data.getGeneratedUrlStep()} />
      <Image src={imageUrls.GeneratedUrlBotSetup} alt="generated-url-bot-setup" placeholder="blur" />
      <OrderedList start={14} items={data.getBotAdditionStep()} />
      <Image src={imageUrls.AddBotToServerBotSetup} alt="add-bot-to-server-bot-setup" placeholder="blur" />
      <OrderedList start={15} items={data.getAuthorizationStep()} />
      <Image src={imageUrls.AuthoriseBotSetup} alt="authorise-bot-setup" placeholder="blur" />
      <OrderedList start={16} items={data.getBotVisibilityStep()} />
      <Image src={imageUrls.BotInServerBotSetup} alt="bot-in-server-bot-setup" placeholder="blur" />
