---
title: "Smart Devices"
pageTitle: "Smart Devices"
description: "Smart Devices is an umbrella term for three different devices, Smart Switches, Smart Alarms and Storage Monitors. To pair a Smart Device with rustplusplus,"
order: 8
upstream: "https://github.com/alexemanuelol/rustplusplus/blob/8f7300e4e3dd68392f2b01ead5d711697f63ac63/docs/smart_devices.md"
upstreamPath: "docs/smart_devices.md"
upstreamSha: "8f7300e4e3dd68392f2b01ead5d711697f63ac63"
syncedAt: "2026-09-24T03:01:15.169Z"
license: GPL-3.0
ads: false
---
> Smart Devices is an umbrella term for three different devices, `Smart Switches`, `Smart Alarms` and `Storage Monitors`. To pair a Smart Device with rustplusplus, make sure you've [setup the Credentials](/docs/credentials). When the Credentials are setup, you just need a `wire tool` and start pairing like you would with the [Rust+ Companion App](https://rust.facepunch.com/companion). Once you've paired your Smart Devices, they should appear in their respective Discord Text-Channel (`switches`, `alarms` or `storagemonitors`).
<br>
...
![Image of a Smart Switch](/images/upstream/smart_devices/smart_switch.png)
...
![Image of a Smart Switch Group](/images/upstream/smart_devices/smart_switch_group.png)
...
![Image of a Smart Alarm](/images/upstream/smart_devices/smart_alarm.png)
...
![Image of a Storage Monitor](/images/upstream/smart_devices/storage_monitor_tool_cupboard.png)
![Image of a Storage Monitor](/images/upstream/smart_devices/storage_monitor_container.png)
...
![Image of an unreachable Smart Device](/images/upstream/smart_devices/unreachable_device.png)
