---
title: "Credentials (Web)"
pageTitle: "Credentials Documentation (Web Version)"
description: "To be able to use an instance of the bot properly, you need to set up your Credentials. Adding these credentials makes it possible for you to pair with ser"
order: 3
upstream: "https://github.com/alexemanuelol/rustplusplus/blob/8f7300e4e3dd68392f2b01ead5d711697f63ac63/docs/credentials_web_version.md"
upstreamPath: "docs/credentials_web_version.md"
...
> [rustPlusPlus-Credentials Firefox Extension](https://addons.mozilla.org/en-US/firefox/addon/rustplusplus-credential-app)
   ...
   ![rustplusplus Click Install Extension Image](/images/upstream/bot_setup/click_install_extension.png)

   ![rustplusplus After Click Install Extension Image](/images/upstream/bot_setup/after_click_install_extension.png)

3. **Click the Log In button to proceed with the Steam login.**

   ![Steam Account login Image](/images/upstream/bot_setup/steam_login_web.png)

4. **After logging in, you will be redirected to the display page where the slash command will be shown `/credentials add ....`**

   ![rustplusplus Display Page](/images/upstream/bot_setup/rustplusplus_display_page.png)

5. **Click `Copy` to copy the Slash Command.**

   ![Credentials copy Image](/images/upstream/bot_setup/click_copy_to_clipboard.png)
...
6. **Paste the Slash Command in your Discord Server Text Channel. The specific Text Channel does not matter, as long as the bot has access to it.**
   ...
   ![FCM Credentials discord Image](/images/upstream/bot_setup/credentials_discord.png)
